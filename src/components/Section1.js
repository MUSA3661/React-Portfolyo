          ...
          <div class="card h-100" style={{width:"100%"}}>
            <div class="card-body">
              ...
              <p class="card-text text-capitalize fs-5">
                Hayalleri uğruna savaşan bir kardeşiniz
              </p>
              ...
              <button
                type="button"
                class="section1-button rounded-4 border-danger"
              >
                CV GÖZAT
              </button>
            </div>
          ...
          <div class="card h-100" style={{width:"100%"}}>
            <div class="card-body">
              ...
              <ul>
                ...
                <li class="mb-2">
                  YAŞADIĞI-İL:<span class="text-muted ms-2">Kars/Merkez</span>
                </li>
                <li class="mb-2">
                ...
                <li class="mb-2">
                  ADRESS:<span class="text-muted text-capitalize ms-2"
                    >örnek mah.ali gaffar okkan bulvarı.ayka gold sitesi kat:2
                    daire:5</span
                  >
                </li>
              </ul>
